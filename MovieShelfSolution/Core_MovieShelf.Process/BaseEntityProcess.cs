...
namespace Core_MovieShelf.Process
{
    ...
    public class BaseEntityProcess<TEntity, TEntityList, TKey, TFlag> : BaseProcess<TEntity, TEntityList, TKey, TFlag>, IBaseEntityProcess<TEntity, TEntityList, TKey, TFlag>
        where TEntity : BaseEntity, new()
        where TEntityList : IDomainList<TEntity, IEnumerable<TEntity>>
    {
        #region IDal<TEntity,TEntityList,TKey> Members

        public BaseEntityProcess(IBaseDal<TEntity, TEntityList, TKey> provider) : base(provider)
        {
        }
