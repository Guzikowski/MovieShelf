...
namespace Core_MovieShelf.Test.ContractTests
{
	...
	/// </summary>
	[TestFixture]
	public class BaseLookupTest : AutoMockerBase<BaseLookupContract>
	{
		...
		/// </summary>
		/// <returns></returns>
		private static BaseLookupContract CreateTargetObject()
		{
			return new BaseLookupContract();
		}
		...
		/// </summary>
		/// <returns></returns>
		private static IBaseLookupContract CreateTargetInterfaceObject()
		{
			IBaseLookupContract target = CreateTargetObject();
			return target;
		}
		#endregion
